    ...
    return (
        <div className='flex flex-col items-center w-full overflow-hidden relative bg-[url(/assets/images/webp/hero-bg.webp)] bg-cover bg-no-repeat bg-center'>
            <div className="max-w-[1332px] px-4 w-full mx-auto">
                <Header />
                <Image className='!max-w-[777px] xl:pt-[63px] xl:pb-[54px] max-xl:py-11 max-lg:py-8 max-md:py-5 mx-auto w-full pointer-events-none animate__animated animate__bounceInUp' src="/assets/images/webp/peperuney-img.webp" alt="buy-button" width={777} height={283} />
