    ...
    return (
        <div className='flex flex-col items-center w-full overflow-hidden relative bg-[url(/assets/images/webp/hero-bg.webp)] bg-cover bg-no-repeat bg-center'>
            ...
            <div className='relative w-full h-[100px] bg-red mx-auto flex justify-center items-center'>
                <Image className='!max-w-[1920px] absolute pointer-events-none bottom-[100px] mx-auto w-full' src="/assets/images/webp/hero-pizza-img.webp" alt="pizza-img" width={1920} height={244} />
