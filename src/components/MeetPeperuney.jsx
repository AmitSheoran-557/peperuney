        ...
        <div className="flex flex-col w-full bg-[url(/assets/images/webp/meet-peperuney-bg.webp)] relative overflow-hidden bg-cover bg-no-repeat bg-center">
                ...
                <div className="max-w-[1332px] px-4 w-full mx-auto">
                    <div className="flex flex-wrap justify-center max-lg:flex-col-reverse items-center">
                        <div className="lg:w-5/12 w-full max-lg:flex justify-center">
                            <Image className='!max-w-[580px] xl:min-w-[580px] w-full pointer-events-none' src="/assets/images/webp/meet-peperuney-pizza-img.webp" alt="pizza-delivery-img" width={580} height={530} />
                        </div>
                        <div className="lg:w-7/12 w-full flex flex-col lg:items-end items-center text-start">
                            ...
                            <div className="relative max-w-[715px] min-w-sm w-full sm:bg-[url(/assets/images/webp/white-board-bg.webp)] max-sm:min-w-[355px] max-sm:bg-[url(/assets/images/webp/sm-white-board-bg.webp)] bg-center bg-[length:100%_100%] bg-no-repeat bg-">
                                ...
                                <div className="flex max-w-[624px] border-t-2 pt-5 xl:pb-13 pb-14 mx-auto  sm:ms-14 ms-7 me-6 items-center justify-between">
                                    ...
                                    <Link className="transition-transform transform hover:scale-x-105 animate-move-scale" href="#">
                                        <Image className='xl:!max-w-[262px] md:max-w-56 sm:max-w-48 max-w-[119px] w-full' src="/assets/images/webp/manifesto-btn.webp" alt="manifesto-btn" width={262} height={74} />
                                    </Link>
                                </div>
                            </div>
                        </div>
            ...
            <div className="lg:pt-[867px] pt-[750px] bg-[url(/assets/images/webp/meet-peperuney-bg-2.webp)] bg-cover bg-no-repeat bg-center">
                <div className="mx-auto w-full">
                    <Link href="/">
                        <Image className='xl:!max-w-[262px] lg:max-w-56 transition-transform transform hover:scale-x-105 animate-move-scale md:max-w-48 sm:max-w-44 max-w-40 mx-auto w-full' src="/assets/images/webp/buy-pepruney-btn.webp" alt="buy-button" width={262} height={74} />
                    </Link>
