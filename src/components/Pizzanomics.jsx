    ...
    return (
        <div className='flex bg-red overflow-hidden'>
            <div className="max-w-[1920px] w-full mx-auto relative flex flex-col items-center">
                ...
                <div className="mt-20 max-w-[1920px] mx-auto bg-[url(/assets/images/webp/bricks-bg-img.webp)] bg-cover w-full bg-no-repeat bg-center">
                    <div className="flex flex-wrap justify-center lg:pt-40 pt-32 relative">
                        <div className="lg:w-7/12 w-full flex flex-col items-center">
                            ...
                            <Link href="/" className='bg-[url(/assets/images/webp/buy-btn-bg.webp)] gap-4 relative z-10 bg-[length:100%_100%] lg:max-w-[313px] lg:h-[97px] h-[74px] flex justify-center items-center transition-transform transform hover-animation animate__animated max-w-[335px] w-full'>
                    ...
                    <div className="flex flex-wrap justify-center max-w-[1200px] bg-red-gradient relative z-10 mx-auto py-5 xl:gap-[60px] lg:gap-10 gap-7">
                        {BAKE_TO_EARN_BTN_LIST.map((item, index) => (
                            <Link key={index} href="#" className="flex flex-col items-center hover-animation-2">
                                <Image className='xl:!max-w-[360px] transition-transform transform lg:max-w-64 max-w-[236px] w-full' src={item.image} alt="pizza-img" width={360} height={40} />
                            </Link>
                        ))}
                    </div>
