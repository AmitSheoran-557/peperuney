        ...
        <div className='flex flex-col justify-center items-center lg:pt-[30px] pt-5'>
            <div className="max-w-[1300px] w-full mx-auto">
                <div className="flex justify-between items-center">
                    <Link href="/" className='bg-[url(/assets/images/webp/buy-btn-bg.webp)] bg-[length:100%_100%] lg:max-w-[262px] transition-transform transform hover:scale-x-105 animate-move-scale md:max-w-48 sm:max-w-40 max-w-[132px] w-full'>
