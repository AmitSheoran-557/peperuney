                    ...
                    <div className="flex xl:gap-10 lg:gap-9 md:gap-7 sm:gap-5 gap-3 items-center">
                        <div className="relative">
                            <div className="flex items-center cursor-pointer" onClick={toggleDropdown}>
                                <img className="lg:max-w-[41px] lg:min-w-[41px] pointer-events-none md:min-w-9 min-w-8 lg:h-[31px] h-6 md:max-w-9 max-w-8 w-full" src={selectedFlag} alt="selected-flag" width={41} height={31} />
